...
plugins=(git sudo web-search colorize cp extract history safe-paste screen dnf themes  aws bower command-not-found common-aliases dirhistory extract nmap)
